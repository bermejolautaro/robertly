...
import ***REMOVED*** ChangeDetectionStrategy, Component, ElementRef, Input, ViewChild, inject ***REMOVED*** from '@angular/core';
...
export class CreateOrUpdateLogModalComponent ***REMOVED***
  ...
  @Input(***REMOVED*** required: true ***REMOVED***) public createOrUpdateLogFormGroup: CreateOrUpdateLogFormGroup = null!;
