(() => {
  ...
  var CacheTable = class {
    ...
    "delete"(key) {
      return this.cache.delete(this.request(key), this.cacheQueryOptions).catch((e) => console.log(e)).catch((e) => console.log(e)).catch((e) => console.log(e)).catch((e) => console.log(e));
    }
    keys() {
      return this.cache.keys().then((requests) => requests.map((req) => req.url.slice(1)));
    }
    read(key) {
      return this.cache.match(this.request(key), this.cacheQueryOptions).catch((e) => console.log(e)).catch((e) => console.log(e)).catch((e) => console.log(e)).catch((e) => console.log(e)).then((res) => {
        if (res === void 0) {
    ...
    write(key, value) {
      return this.cache.put(this.request(key), this.adapter.newResponse(JSON.stringify(value))).catch((e) => console.log(e)).catch((e) => console.log(e)).catch((e) => console.log(e)).catch((e) => console.log(e));
    }
  };
...
${error.stack}`;
  ...
  var AssetGroup = class {
    ...
    async cacheStatus(url) {
      ...
      const res = await cache.match(req, this.config.cacheQueryOptions).catch((e) => console.log(e)).catch((e) => console.log(e)).catch((e) => console.log(e)).catch((e) => console.log(e));
      if (res === void 0) {
    ...
    async handleFetch(req, _event) {
      ...
      if (this.urls.indexOf(url) !== -1 || this.patterns.some((pattern) => pattern.test(url))) {
        ...
        let cachedResponse;
        try {
          cachedResponse = await cache.match(req, this.config.cacheQueryOptions).catch((e) => console.log(e)).catch((e) => console.log(e)).catch((e) => console.log(e)).catch((e) => console.log(e));
        } catch (error) {
    ...
    async fetchFromCacheOnly(url) {
      ...
      const response = await cache.match(request, this.config.cacheQueryOptions).catch((e) => console.log(e)).catch((e) => console.log(e)).catch((e) => console.log(e)).catch((e) => console.log(e));
      if (response === void 0) {
        return null;
      }
      let metadata = void 0;
    ...
    async fetchAndCacheOnce(req, used = true) {
      ...
      try {
        ...
        try {
          const cache = await this.cache;
          await cache.put(req, res.clone()).catch((e) => console.log(e)).catch((e) => console.log(e)).catch((e) => console.log(e)).catch((e) => console.log(e));
    ...
    async maybeUpdate(updateFrom, req, cache) {
      ...
      if (this.hashes.has(url)) {
        ...
        if (res !== null) {
          await cache.put(req, res).catch((e) => console.log(e)).catch((e) => console.log(e)).catch((e) => console.log(e)).catch((e) => console.log(e));
          return true;
        }
      }
      return false;
  ...
  var PrefetchAssetGroup = class extends AssetGroup {
    async initializeFully(updateFrom) {
      ...
      await this.urls.reduce(async (previous, url) => {
        ...
        try {
          alreadyCached = await cache.match(req, this.config.cacheQueryOptions).catch((e) => console.log(e)).catch((e) => console.log(e)).catch((e) => console.log(e)).catch((e) => console.log(e)) !== void 0;
        } catch (error) {
      ...
      if (updateFrom !== void 0) {
        ...
        await (await updateFrom.previouslyCachedResources()).filter((url) => this.urls.indexOf(url) !== -1 || this.patterns.some((pattern) => pattern.test(url))).reduce(async (previous, url) => {
          await previous;
          const req = this.adapter.newRequest(url);
          const alreadyCached = await cache.match(req, this.config.cacheQueryOptions).catch((e) => console.log(e)).catch((e) => console.log(e)).catch((e) => console.log(e)).catch((e) => console.log(e)) !== void 0;
          if (alreadyCached) {
            return;
          }
          ...
          await cache.put(req, res.response).catch((e) => console.log(e)).catch((e) => console.log(e)).catch((e) => console.log(e)).catch((e) => console.log(e));
  ...
  var DataGroup = class {
    ...
    async loadFromCache(req, lru) {
      const cache = await this.cache;
      let res = await cache.match(req, this.config.cacheQueryOptions).catch((e) => console.log(e)).catch((e) => console.log(e)).catch((e) => console.log(e)).catch((e) => console.log(e));
      if (res !== void 0) {
        try {
